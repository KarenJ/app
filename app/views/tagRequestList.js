define(function (require) {
	...
	var $					= require('jquery'),
		...
		tpl 				= require('text!tpl/tagRequestList.html'),
		DefaultItem 	    = require('app/views/tagRequestItem'),
	...
	return Backbone.View.extend({
		...
		render: function () {
			...
			var myScroll = new iScroll( 'tagRequest' , {
 					useTransition: true,
					vScroll: true,
			});
			...
			_.each(this.subViews, function(view) {
				this.$el.find('ul#tagRequestList').append(view.$el[0]);
			}, this);
